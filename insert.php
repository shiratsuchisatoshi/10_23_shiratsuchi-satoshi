...
//３．データ登録SQL作成
$sql="INSERT INTO gs_itunes_table(artistName,collectionName,previewUrl,indate)VALUES (:name,:album,:url,sysdate())";
// $sql="INSERT INTO gs_itunes_table(artistName,collectionName,previewUrl,indate)VALUES (:name,:url,:cm,sysdate())";

$stmt = $pdo->prepare($sql);
// bindvalueを通すとPOSTデータで危ない文字列を無効化している
$stmt->bindValue(':name', $name, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':album', $album, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
